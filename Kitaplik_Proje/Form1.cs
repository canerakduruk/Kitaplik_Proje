...
namespace Kitaplik_Proje
{
    public partial class Form1 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\canak\Desktop\Kitaplik.mdb");
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("Kitap Listeden Silindi");
        }
        ...
        private void BtnBul_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p1", TxtBulunacakKitap.Text);
            DataTable dt = new DataTable();
        ...
        {
            baglanti.Open();
            OleDbCommand komut = new OleDbCommand("Select * from Kitaplar where KitapAd like '%"+TxtBulunacakKitap.Text+"%'", baglanti);
            DataTable dt = new DataTable();
            OleDbDataAdapter da = new OleDbDataAdapter(komut);
            da.Fill(dt);
            dataGridView1.DataSource = dt;
